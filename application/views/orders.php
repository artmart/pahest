...
<div class="order_popup col-md-12 col-lg-12" id="new_order_popup">
    ...
    <form id="new_order_form" action="orders/new_order" method="post">
        <div id='clonedSection1' class='clonedSection col-md-3 col-lg-3'>
            Ընտրել կլիենտ:<br />
            <select id="client_to_pick1" name="client_to_pick1" class="client_to_pick selectpicker" data-live-search="true"><br />
                <?php
            ...
            Ընտրել ապրանք:<br />
            <select id="product_to_pick1" class="product_to_pick selectpicker" data-live-search="true" name="product_to_pick1"><br />
                <?php
            ...
            <div class="pre_order">
            Նախնական պատվեր:
            <input id="preorder1" class="preorder" type="checkbox" name="preorder1" /><br />
            </div>
